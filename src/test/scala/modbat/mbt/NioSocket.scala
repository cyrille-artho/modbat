...
class NioSocket extends fixture.FlatSpec with fixture.TestDataFixture with Matchers {
  ...
  "NioSocket12" should "pass" in { td =>
    val result = ModbatTestHarness.testMain(Array("--mode=dot","--auto-labels","modbat.examples.NioSocket1"), ModbatTestHarness.setExamplesJar, td)
    result._1 should be(0)
    result._3 shouldBe empty
  }
...
// special case 
  "NioSocket13" should "pass" in { td =>
    val result = ModbatTestHarness.testMain(Array("--mode=dot","--auto-labels","--dot-dir=dot_test","modbat.examples.NioSocket1"), ModbatTestHarness.setExamplesJar, td)
    result._1 should be(0)
    result._3 shouldBe empty
  }
  ...
  "NioSocket15" should "pass" in { td =>
    val result = ModbatTestHarness.testMain(Array("-n=10","-s=1","--dotify-coverage","--auto-labels","modbat.examples.NioSocket1"), ModbatTestHarness.setExamplesJar, td)
    result._1 should be(0)
    result._3 shouldBe empty
  }
  ...
  "NioSocket16" should "pass" in { td =>
    val result = ModbatTestHarness.testMain(Array("-n=100","-s=1","--dotify-coverage","--auto-labels","modbat.examples.NioSocket1"), ModbatTestHarness.setExamplesJar, td)
    result._1 should be(0)
    result._3 shouldBe empty
  }
  ...
  "NioSocket17" should "pass" in { td =>
    val result = ModbatTestHarness.testMain(Array("-n=500","-s=1","--dotify-coverage","--auto-labels","modbat.examples.NioSocket1"), ModbatTestHarness.setExamplesJar, td)
    result._1 should be(0)
    result._3 shouldBe empty
  }
  ...
  "NioSocket18" should "pass" in { td =>
    val result = ModbatTestHarness.testMain(Array("-n=500","-s=1","--maybe-probability=0","--dotify-coverage","--auto-labels","modbat.examples.NioSocket1"), ModbatTestHarness.setExamplesJar, td)
    result._1 should be(0)
    result._3 shouldBe empty
  }
