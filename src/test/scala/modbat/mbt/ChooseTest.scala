...
class ChooseTest extends fixture.FlatSpec with fixture.TestDataFixture with Matchers {
  ...
  "ChooseTest2" should "pass" in { td =>
    val result = ModbatTestHarness.testMain(Array("--mode=dot","--show-choices","modbat.test.ChooseTest"), ModbatTestHarness.setTestJar, td, false, Some("modbat.test.ChooseTest.dot","chooseTest.dot"))
    result._1 should be(0)
    result._3 shouldBe empty
  }
