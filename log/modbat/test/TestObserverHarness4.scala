...
object TestObserverHarness4 {
  def test402b73cd0066eaea() {
    ...
    // modbat/test/ObserverHarness4.scala:8: modbat.test.ObserverHarness4-1: launch
    ...
    // modbat/test/ObserverHarness4.scala:10: modbat.test.ObserverHarness4-1: skip

    m0.executeTransition(m0.getTransition(2))
    // modbat/test/ObserverHarness4.scala:12: modbat.test.ObserverHarness4-1: i
    ...
    // modbat/test/ObserverHarness4.scala:15: modbat.test.ObserverHarness4-1: i
  ...
  def main(args: Array[String]) {
    ...
    MBT.loadModelClass ("modbat.test.ObserverHarness4")
