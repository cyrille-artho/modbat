...
object TestComplexLaunch4 {
  def test402b73cd0066eaea() {
    ...
    // modbat/test/ComplexLaunch4.scala:17: modbat.test.ComplexLaunch4-1: skip

    m0.executeTransition(m0.getTransition(2))
    // modbat/test/ComplexLaunch4.scala:22: modbat.test.ComplexLaunch4-1: launch
    ...
    // modbat/test/ComplexLaunch4.scala:27: modbat.test.ComplexLaunch4-1: assert

    val m1: MBT = MBT.getLaunchedModel(1)
    m1.executeTransition(m1.getTransition(0))
    // modbat/test/ComplexLaunch4.scala:17: modbat.test.ComplexLaunch4-2: skip

    m1.executeTransition(m1.getTransition(3))
    // modbat/test/ComplexLaunch4.scala:27: modbat.test.ComplexLaunch4-2: assert

    val m2: MBT = MBT.getLaunchedModel(2)
    m2.executeTransition(m2.getTransition(0))
    // modbat/test/ComplexLaunch4.scala:17: modbat.test.ComplexLaunch4-3: skip

    m2.executeTransition(m2.getTransition(3))
    // modbat/test/ComplexLaunch4.scala:27: modbat.test.ComplexLaunch4-3: assert

    val m3: MBT = MBT.getLaunchedModel(3)
    m3.executeTransition(m3.getTransition(0))
    // modbat/test/ComplexLaunch4.scala:17: modbat.test.ComplexLaunch4-4: skip

    m3.executeTransition(m3.getTransition(2))
    // modbat/test/ComplexLaunch4.scala:22: modbat.test.ComplexLaunch4-4: launch

    m3.executeTransition(m3.getTransition(1))
    // modbat/test/ComplexLaunch4.scala:18: modbat.test.ComplexLaunch4-4: launch
    ...
    // modbat/test/Child4.scala:20: modbat.test.Child4-2: skip

    val m5: MBT = MBT.getLaunchedModel(5)
    m5.executeTransition(m5.getTransition(0))
    // modbat/test/Child4.scala:20: modbat.test.Child4-1: skip

    m6.executeTransition(m6.getTransition(2))
    // modbat/test/Child4.scala:25: modbat.test.Child4-2: assert

    m5.executeTransition(m5.getTransition(2))
    // modbat/test/Child4.scala:25: modbat.test.Child4-1: assert

    val m4: MBT = MBT.getLaunchedModel(4)
    m4.executeTransition(m4.getTransition(0))
    // modbat/test/ComplexLaunch4.scala:17: modbat.test.ComplexLaunch4-5: skip

    m3.executeTransition(m3.getTransition(3))
    // modbat/test/ComplexLaunch4.scala:27: modbat.test.ComplexLaunch4-4: assert

    m4.executeTransition(m4.getTransition(1))
    // modbat/test/ComplexLaunch4.scala:18: modbat.test.ComplexLaunch4-5: launch

    m4.executeTransition(m4.getTransition(2))
    // modbat/test/ComplexLaunch4.scala:22: modbat.test.ComplexLaunch4-5: launch

    val m8: MBT = MBT.getLaunchedModel(8)
    m8.executeTransition(m8.getTransition(0))
    // modbat/test/ComplexLaunch4.scala:17: modbat.test.ComplexLaunch4-6: skip

    m8.executeTransition(m8.getTransition(2))
    // modbat/test/ComplexLaunch4.scala:22: modbat.test.ComplexLaunch4-6: launch

    val m9: MBT = MBT.getLaunchedModel(9)
    m9.executeTransition(m9.getTransition(0))
    // modbat/test/ComplexLaunch4.scala:17: modbat.test.ComplexLaunch4-7: skip

    m4.executeTransition(m4.getTransition(2))
    // modbat/test/ComplexLaunch4.scala:22: modbat.test.ComplexLaunch4-5: launch

    m9.executeTransition(m9.getTransition(3))
    // modbat/test/ComplexLaunch4.scala:27: modbat.test.ComplexLaunch4-7: assert

    m4.executeTransition(m4.getTransition(2))
    // modbat/test/ComplexLaunch4.scala:22: modbat.test.ComplexLaunch4-5: launch

    m8.executeTransition(m8.getTransition(1))
    // modbat/test/ComplexLaunch4.scala:18: modbat.test.ComplexLaunch4-6: launch

    val m12: MBT = MBT.getLaunchedModel(12)
    m12.executeTransition(m12.getTransition(0))
    // modbat/test/Child4.scala:20: modbat.test.Child4-4: skip
    ...
    // modbat/test/Child4.scala:22: modbat.test.Child4-4: id

    val m13: MBT = MBT.getLaunchedModel(13)
    m13.executeTransition(m13.getTransition(0))
    // modbat/test/ComplexLaunch4.scala:17: modbat.test.ComplexLaunch4-10: skip
    ...
    // modbat/test/ComplexLaunch4.scala:18: modbat.test.ComplexLaunch4-10: launch

    val m7: MBT = MBT.getLaunchedModel(7)
    m7.executeTransition(m7.getTransition(0))
    // modbat/test/Child4.scala:20: modbat.test.Child4-3: skip

    m8.setExpectedException("java.lang.AssertionError")
    m8.executeTransition(m8.getTransition(3))
    // modbat/test/ComplexLaunch4.scala:27: modbat.test.ComplexLaunch4-6: assert
  ...
  def main(args: Array[String]) {
    ...
    MBT.loadModelClass ("modbat.test.ComplexLaunch4")
