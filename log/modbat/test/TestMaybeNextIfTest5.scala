...
object TestMaybeNextIfTest5 {
  def test3ba471c1785a0175() {
    ...
    // modbat/test/MaybeNextIfTest5.scala:8: println

    m0.setExpectedException("java.lang.AssertionError")
    m0.executeTransition(m0.getTransition(1))
    // modbat/test/MaybeNextIfTest5.scala:12: assert
  ...
  def main(args: Array[String]) {
    ...
    MBT.loadModelClass ("modbat.test.MaybeNextIfTest5")
