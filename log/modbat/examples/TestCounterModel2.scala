...
object TestCounterModel2 {
  def test49a846e52b813972() {
    ...
    // modbat/examples/CounterModel2.scala:10: new Counter

    m0.executeTransition(m0.getTransition(1))
    // modbat/examples/CounterModel2.scala:13: toggle

    m0.executeTransition(m0.getTransition(2))
    // modbat/examples/CounterModel2.scala:16: inc1

    m0.executeTransition(m0.getTransition(3))
    // modbat/examples/CounterModel2.scala:19: inc1

    m0.setExpectedException("java.lang.AssertionError")
    m0.executeTransition(m0.getTransition(5))
    // modbat/examples/CounterModel2.scala:25: assert
  ...
  def main(args: Array[String]) {
    ...
    MBT.loadModelClass ("modbat.examples.CounterModel2")
